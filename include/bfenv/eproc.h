...
enum bfenv_eproc_type {
    ...
    BFENV_EPROC_EOF = BFDEV_BIT(__BFENV_EPROC_EOF),
    BFENV_EPROC_ERROR = BFDEV_BIT(__BFENV_EPROC_ERROR),
...
BFDEV_BITFLAGS(bfenv_eproc_eof, __BFENV_EPROC_EOF)
BFDEV_BITFLAGS(bfenv_eproc_error, __BFENV_EPROC_ERROR)
